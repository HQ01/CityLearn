...
class Buffer:
    ...
    def sample(self, sample_size):
        ...
        return torch.tensor(s, dtype=torch.float32, device=self.device), torch.tensor(a, dtype=torch.float32,
                                                                                      device=self.device), torch.tensor(
            r, dtype=torch.float32, device=self.device), torch.tensor(s_next, dtype=torch.float32,
